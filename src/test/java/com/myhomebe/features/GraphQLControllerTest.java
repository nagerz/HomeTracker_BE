...
public class GraphQLControllerTest{
  ...
  public void testGetProjects() throws URISyntaxException{
    ...
    String expected = "{\"data\":{\"projects\":[{\"id\":1,\"name\":\"House 1\",\"description\":\"Big, white house\",\"address\":\"123 Fake St.\",\"city\":\"Denver\",\"state\":\"CO\",\"zip_code\":\"80205\",\"rooms\":[{\"id\":1},{\"id\":2}]},{\"id\":2,\"name\":\"House 2\",\"description\":\"Small with picket fence\",\"address\":\"456 Random Lane\",\"city\":\"Denver\",\"state\":\"CO\",\"zip_code\":\"80205\",\"rooms\":[{\"id\":3}]}]}}";
  ...
  public void testUpdateProject() throws URISyntaxException{
    ...
    URI uri = new URI(baseUrl);
		...
		JSONObject body = new JSONObject();
		body.put("query", "mutation{updateProject(project: {id: 2, name: \"Updated House\", description: \"test project update\", address: \"updated address\", city: \"Different City\", state: \"Different state\", zip_code: \"Different zip\"}) {id name description address city state zip_code}}");

    HttpEntity<JSONObject> request = new HttpEntity<JSONObject>(body);

    ResponseEntity<String> result = this.restTemplate.postForEntity(uri, request, String.class);

    String expected = "{\"data\":{\"updateProject\":{\"id\":2,\"name\":\"Updated House\",\"description\":\"test project update\",\"address\":\"updated address\",\"city\":\"Different City\",\"state\":\"Different state\",\"zip_code\":\"Different zip\"}}}";
    //Verify request succeed
    Assert.assertEquals(200, result.getStatusCodeValue());
    Assert.assertEquals(expected, result.getBody());
  }
  ...
  @Test
  public void testUpdateRoom() throws URISyntaxException{
    final String baseUrl = "http://localhost:"+randomServerPort+"/api/v1/graphql/";
    URI uri = new URI(baseUrl);

    //Before update
		JSONObject body1 = new JSONObject();
		body1.put("query", "{room(id: 1) {id name type description}}");

    HttpEntity<JSONObject> request1 = new HttpEntity<JSONObject>(body1);

    ResponseEntity<String> result1 = this.restTemplate.postForEntity(uri, request1, String.class);

    String expected1 = "{\"data\":{\"room\":{\"id\":1,\"name\":\"Living Room 1\",\"type\":\"Living Room\",\"description\":\"Northeast living room\"}}}";
    ...
    //Update request
    JSONObject body2 = new JSONObject();
		body2.put("query", "mutation{updateRoom(room: {id: 1, name: \"Updated Bedroom\", type: \"updated type\", description: \"test update room\"}) {id name type description roomMaterials{id}}}");

    HttpEntity<JSONObject> request2 = new HttpEntity<JSONObject>(body2);

    ResponseEntity<String> result2 = this.restTemplate.postForEntity(uri, request2, String.class);

    String expected2 = "{\"data\":{\"updateRoom\":{\"id\":1,\"name\":\"Updated Bedroom\",\"type\":\"updated type\",\"description\":\"test update room\",\"roomMaterials\":[{\"id\":1},{\"id\":2}]}}}";
    ...
    //Verify database after request
    JSONObject body3 = new JSONObject();
    body3.put("query", "{room(id: 1) {id name type description}}");

    HttpEntity<JSONObject> request3 = new HttpEntity<JSONObject>(body3);

    ResponseEntity<String> result3 = this.restTemplate.postForEntity(uri, request3, String.class);

    String expected3 = "{\"data\":{\"room\":{\"id\":1,\"name\":\"Updated Bedroom\",\"type\":\"updated type\",\"description\":\"test update room\"}}}";
